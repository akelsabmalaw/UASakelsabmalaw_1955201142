 ...
 */
package pemrogaman_berbasisGUI;
...
public class ProgramKasir extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        jLabel1.setText("Toko Kita Jodoh Langgeng Samawa");

        RBNG.setText("Krudung");
    ...
    private void RBMGActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_RBMGActionPerformed
        // TODO add your handling code here:
         int BajuGamis=150000;
        if(RBMG.isSelected()){
            TxtRBMG.setText("" +RBMG.getText());
            TxtRBMG.setText("" +BajuGamis);
        }else{
            TxtRBMG.setText("");
        }
    ...
    private void RBSAActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_RBSAActionPerformed
        // TODO add your handling code here:
         int BajuBatik=100000;
        if(RBSA.isSelected()){
            TxtRBSA.setText("" +RBSA.getText());
            TxtRBSA.setText("" +BajuBatik);
        }else{
            TxtRBSA.setText("");
        }
